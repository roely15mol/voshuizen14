const links = [
  ...
  {
    label: "PostNL",
    href: "https://www.postnl.nl/tracktrace/",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
      ...
      <div className="mt-3 flex flex-wrap gap-3">
        {links.map((link) => (
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-card-border px-3 py-2 text-sm hover:border-accent hover:text-accent"
          >
            {link.icon}
            {link.label}
          </a>
